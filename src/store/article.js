...
import {
  onStart, onSuccess, onFailure, shouldFetch, getReducerData, getReducerStatus
} from 'common/helpers'
...
// SELECTORS
export const getArticle = (state, articleId) => getReducerData(state.article, articleId)
export const getArticleStatus = (state, articleId) => getReducerStatus(state.article, articleId)
